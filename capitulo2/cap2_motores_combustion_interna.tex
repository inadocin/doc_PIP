...
\begin{figure} \centering
\includegraphics[width=\textwidth]{sintonia_heywood.jpg}
    \caption{Diagrama de presión vs ángulo de cigüeñal~\parencite{heywood}}\label{fig:sintonia_adm}
\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Sintonización del Sistema de Escape}
...
\begin{figure} \centering
\includegraphics[width=.7\textwidth]{ciclo/comparativa_rendimientos_ciclos.png}
