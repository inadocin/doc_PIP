...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{mapa_cd/mc_s2_mapa_adm.png}
...
RPM.
% TODO: Revisar esto con el delta P, el flujo es hacia afuera del puerto (ver flujometria 10 7000rpm)
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.7\textwidth]{mapa_cd/mc_s2_mapa_esc.png}
