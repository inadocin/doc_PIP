...
que se ilustra en la figura~\ref{fig:motor_cad1} y~\ref{fig:motor_cad2}, qpjjjse
redondearon las aristas internas incluyendo las paletas y las puntas del rotor
para favorecer el proceso de mallado, ya que los bordes agudos pueden ser
problmeáticos para el mallador \emph{snappyHexMesh}.
...
tercios del a altura de cámara, se decidió mantener el eje central de cada
puerto de forma que intersecte el centro del motor para eliminar una variable de
la geometŕia a modelar siendo el diámetro del puerto y el reglaje del mismo los
factores importantes tomados para la optimización.
%
