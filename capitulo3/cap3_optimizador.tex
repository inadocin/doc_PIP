...
funciones dió como resultado una curva de rendimiento volumétrico aserrada como
...
curvas suaves y preferentemente un solo punto de inflexión.
%
Además, se implementó una suma ponderada, para obtener un rendimiento
volumétrico máximo en un valor de 6000 RPM.
%
Este objetivo de velocidades se colocó para aprovechar las características de
...
que mejores resultados dió, la metodología utilizada se resume a continuación.
...
inválidas que devuelven puntaje nulo.
%
...
%
Estos individuos o soluciones con puntajes relativamente altos en las primeras
iteraciones tienen una mayor probabilidad de ``pasar'' sus características
geométricas a generaciones futuras y es especialmente problemático en
optimizaciones con pocos individuos (de alrededor de 100).
%
Para reducir la posibilidad de una convergencia temprana se utiliza un método de
escalado de puntajes de la población, que consiste en una transfomración lineal.
%
Definiendo el puntaje bruto de un individuo como $f$, el puntaje escalado es $f'$ y la relación entre ambos es $f' = a\cdot f + b$.
